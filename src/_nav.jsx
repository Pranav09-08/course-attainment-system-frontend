...
export const getNavigation = (role) => {
  ...
  if (role === 'faculty') {
    navigation.push(
      ...
      { component: CNavItem, name: 'My Courses', to: '/faculty-dashboard/mycourses', icon: <CIcon icon={cilList} customClassName="nav-icon" /> },
  ...
  if (role === 'coordinator') {
    navigation.push(
      ...
      { component: CNavItem, name: 'My Courses', to: '/attainment/:courseId/:academicYear', icon: <CIcon icon={cilLibrary} customClassName="nav-icon" /> },
      {
        component: CNavGroup,
        name: 'Attainment',
        icon: <CIcon icon={cilStar} customClassName="nav-icon" />,
